# Bootstrap only: brew bump-cask-pr replaces the version and all three
...
cask "tusklet" do
  ...
  on_macos do
    ...
    url "https://github.com/mattsverse/tusklet/releases/download/v#{version}/Tusklet_#{version}_#{arch}.dmg"
